<script lang="ts">
  ...
  const ICONS: Record<string, string> = {
    ...
    // FOSS United: a plain community mark (two people), not the wordmark.
    fossunited:
      'M9 4a3.5 3.5 0 110 7 3.5 3.5 0 010-7zm0 2a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm7 1a3 3 0 110 6 3 3 0 010-6zm0 2a1 1 0 100 2 1 1 0 000-2zM9 12c3 0 6 1.5 6 4v3H3v-3c0-2.5 3-4 6-4zm0 2c-2.3 0-4 1-4 2v1h8v-1c0-1-1.7-2-4-2zm7 0c2.4 0 5 1.2 5 3.5V19h-4v-2c0-1.1-.4-2-1-2.7V14z',
    github:
    ...
    // LinkedIn: "in" knocked out of the rounded square (even-odd), the shape
    // people know at 16px; the bare letters read as a broken glyph (#473).
    linkedin:
      'M5 2h14a3 3 0 013 3v14a3 3 0 01-3 3H5a3 3 0 01-3-3V5a3 3 0 013-3zM6.4 5.4a1.5 1.5 0 100 3 1.5 1.5 0 000-3zM5.1 9.6V19h2.6V9.6H5.1zm4.4 0V19h2.6v-4.7c0-1.3.3-2.5 1.8-2.5s1.6 1.4 1.6 2.6V19H18v-5.1c0-2.6-.6-4.5-3.5-4.5a3 3 0 00-2.7 1.5V9.6H9.5z',
    mastodon:
    ...
    // Prav: a speech bubble with a dot, the community's own XMPP service.
    prav: 'M4 4h16a1 1 0 011 1v11a1 1 0 01-1 1h-9l-5 4v-4H4a1 1 0 01-1-1V5a1 1 0 011-1zm1 2v9h4v2.6L12.3 15H19V6H5zm7 2.5a2 2 0 110 4 2 2 0 010-4z',
  ...
  /** Marks drawn as a shape with a cut-out; the rest are simple outlines. */
  const EVEN_ODD = new Set(['linkedin']);
      ...
      <li>
        ...
        >
          <svg viewBox="0 0 24 24" aria-hidden="true"
            ><path
              d={ICONS[link.kind] ?? ICONS.website}
              fill-rule={EVEN_ODD.has(link.kind) ? 'evenodd' : undefined}
            /></svg
          >
