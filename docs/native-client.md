...
| Tab / route              | State                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Schedule · Timeline      | one tab, three views switched in the top bar (Timeline · Rooms · Agenda, `ScheduleViews.kt`). Timeline: one time grid, a row per room on a shared axis: a 25-minute talk fills the view, pinch (TalkBack: zoom actions) goes from 5 minutes to 3 hours, and it opens at now. Your resolved plan's talk is gold ("You're going", `NowGo`), else the programme's next ("Up next"); a conflict gets a notice and nothing gold. Devroom colours and pills as on the schedule; empty rooms say "Free until" |
| Schedule · Rooms, Agenda | per day, opening on today scrolled to now with finished sessions dimmed; room chips, agenda list or time × room grid (`ScheduleGrid`, the PWA's TimelineGrid rules), plan markers from the resolved plan (`PlanMarker`: planned / interested / must go / stood aside)                                                                                                                                                                                                                                  |
