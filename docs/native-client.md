...
| Tab / route | State                                                                                                                                                                                                                                                 |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Now         | "Your plan now" (in progress / up next from the resolved plan, or its conflicts), then one lane per room that opens on the talk running there and scrolls right to what is next, room name rotated into the margin, then the programme's next session |
