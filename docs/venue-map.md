...
Rooms: ground `hall-1` (750), `hall-2` (250), `hall-3` (120), `lunch`; first
`room-1` (100), `room-2` (30), `room-3` (30), `hall-1-balcony` (200), `silent`.
...
schedule's own names ("Audi 1") with the drawing's name as a subtitle.
